...
for [Handier](https://github.com/MagicNoThief/Handier-desktop)'s on-device enhancement
layer.
...
Reproduce with [`scripts/enhance-eval/`](https://github.com/MagicNoThief/Handier-desktop/tree/main/scripts/enhance-eval):
